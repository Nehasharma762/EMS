...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        JMenuItem deleteinformation = new JMenuItem("Delete Information");
        deleteinformation.setFont(new Font("monospaced", Font.PLAIN, 12));
        deleteinformation.setBackground(Color.WHITE);
        ImageIcon icon15 = new ImageIcon(ClassLoader.getSystemResource("icon/icon6.png"));
        Image image15 = icon15.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        deleteinformation.setIcon(new ImageIcon(image15));
        deleteinformation.setMnemonic('X');
        deleteinformation.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        }else if (msg.equals("Delete Information")) {
             new DeleteAccount();
